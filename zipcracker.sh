...
figlet zipcracker 1.0
echo " ------------------------------------------------------------------------------ "
echo "   Narzędzie powstało tylko do celów edukacyjnych! --> zipcracker Version 1.0"
echo " ------------------------------------------------------------------------------ "
...
echo -e "\e[31m  [3] (john2zip) SZYBKIE LAMANIE HASLA - SLOWNIK WBUDOWANY\e[0m"
